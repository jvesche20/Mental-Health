...
public class Doctor extends Application {
    ...
    public void start(Stage stage) {         
        ...
        Button addPaitent = Node.getButton("black", "Add Patient", 100.0);
        HBox.setHgrow(spacer, Priority.ALWAYS);
        hBox.getChildren().addAll(Node.goBack("Back to Admin Menu", stage), spacer, addPaitent, Node.logout(stage));
        ...
        table.setOnMouseClicked(e -> {
            if (e.getClickCount() == 2) {
                ...
                Label nameLabel = Node.getLabel("pink", "Name: " + patient.patientName), genderLabel = Node.getLabel("pink", "Gender: " + patient.gender),
                    preIllness = Node.getLabel("pink", "Pre-existing Illnesses:"), drugAlcoholUse = Node.getLabel("pink", "Drug / Alcohol Use:"),
                    Keyword = Node.getLabel("pink", "Keywords:"), illnesses = Node.getLabel("pink", "Possible Illnesses:");
                ...
                Button submit = Node.getButton("pink", "Submit Change", 150.0);
                hBoxForButton.getChildren().addAll(Node.goBack("Back to Doctor View", newStage), spacer3, submit, Node.logout(stage));
                ...
                VBox vBoxForNewStage = Node.getVBox(10.0, "left");
